(() => {
  ...
  Object.assign(copy.it, {
    about: "About", maps: "Mappe", projectTitle: "Low-budget<br>overland in<br><em>inappropriate<br>vehicles.</em>", showProject: "Scopri il progetto", build: "Progetto in corso", soon: "Prossimamente", back: "← Back", backHome: "← Home", gallery: "Galleria",
  ...
  Object.assign(copy.ru, {
    about: "О проекте", maps: "Карты", projectTitle: "Low-budget<br>overland in<br><em>inappropriate<br>vehicles.</em>", showProject: "Открыть проект", build: "Проект в работе", soon: "Скоро", back: "← Назад", backHome: "← Главная", gallery: "Галерея",
  ...
  Object.assign(copy.de, {
    about: "Über das Projekt", maps: "Karten", projectTitle: "Low-budget<br>overland in<br><em>inappropriate<br>vehicles.</em>", showProject: "Projekt ansehen", build: "Projekt in Arbeit", soon: "Demnächst", back: "← Zurück", backHome: "← Startseite", gallery: "Galerie",
